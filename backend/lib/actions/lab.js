...
function createLab(JWTtoken, name, semester, batches, teachers, rooms, timetables, department) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return { status: status == statusCodes_1.statusCodes.OK ? statusCodes_1.statusCodes.FORBIDDEN : status, data: null };
        }
        catch (error) {
            console.error(error);
...
function deleteLabs(JWTtoken, labs) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return { status: status == statusCodes_1.statusCodes.OK ? statusCodes_1.statusCodes.UNAUTHORIZED : status };
        }
        catch (error) {
            console.error(error);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (status == statusCodes_1.statusCodes.OK && user) {
                ...
                return { status: lab ? statusCodes_1.statusCodes.OK : statusCodes_1.statusCodes.NOT_FOUND, data: lab };
            }
            return { status: status, data: null };
        }
        catch (error) {
