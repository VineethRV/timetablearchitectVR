...
const login = (email, pass) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const validatePass = yield bcrypt.compare(pass, (user === null || user === void 0 ? void 0 : user.hashedPass) || "");
        if (!validatePass) {
            return {
  ...
  <body>
    <div class="container">
      ...
      <div class="footer">
        ...
        try {
            yield transport.sendMail(receiver);
            return true;
        }
        catch (_a) {
            return false;
...
function changePassword(verificationToken, email, new_password) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // hash it
            const hashedPass = yield bcrypt.hash(new_password, 10);
            // update it
            try {
...
function forgetOTP(email) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const res = yield checkUserExists(email);
            if (!res) {
                return { status: statusCodes_1.statusCodes.BAD_REQUEST };
            }
        }
  ...
  `;
        ...
        try {
            const info = yield transport.sendMail(receiver);
